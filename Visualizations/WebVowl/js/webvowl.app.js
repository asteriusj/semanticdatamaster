webvowl.app = function (e) {
    ...
    0: function (e, t, n) { n(314), n(316), e.exports = n(317) },
    6: function (e, t) { e.exports = d3 },
    86: function (e, t, n) {
        function o(e) { return null == e ? void 0 === e ? s : l : c && c in Object(e) ? i(e) : a(e) }
        var r = n(87),
            i = n(90),
            a = n(91),
            l = "[object Null]",
    ...
    149: function (e, t) {
        function n(e, t) { for (var n = -1, o = null == e ? 0 : e.length, r = Array(o); ++n < o;) r[n] = t(e[n], n, e); return r } e.exports = n
    },
    214: function (e, t, n) {
        ...
        (function (t) {
            ...
            function o() {
                ...
                if (console.log("Browser Version =" + e), e > 0 && e <= 11 && (t.select("#browserCheck").classed("hidden", !1), t.select("#killWarning").classed("hidden", !0), t.select("#optionsArea").classed("hidden", !0), t.select("#logo").classed("hidden", !0)), 12 == e) {
                    ...
                    o.on("click", function () { console.log("hide the warning please"), t.select("#browserCheck").classed("hidden", !0), t.select("#logo").style("padding", "10px") })
                }
    ...
    318: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
                function n() { t.select("#exportedUrl").node().focus(), t.select("#exportedUrl").node().select(), document.execCommand("copy") }
                ...
                function r() {
                    ...
                    if (void 0 !== d && 0 !== d || (c = s + "#" + l), d > 0) { var u, p = s.split("#"); for (p[1].indexOf("opts=[") >= 0 ? (p[1] = l, c = p[0]) : (c = p[0] + "#", c += l), u = 1; u < p.length; u++) p[u].length > 0 && (c += "#" + p[u]) } a = t.select("#exportedUrl").node(), a.value = c, a.focus(), a.select(), a.title = c
                }
                ...
                function l() { s(".text", [{ name: "font-family", value: "Helvetica, Arial, sans-serif" }, { name: "font-size", value: "12px" }]), s(".subtext", [{ name: "font-size", value: "9px" }]), s(".text.instance-count", [{ name: "fill", value: "#666" }]), s(".external + text .instance-count", [{ name: "fill", value: "#aaa" }]), s(".cardinality", [{ name: "font-size", value: "10px" }]), s(".text, .embedded", [{ name: "pointer-events", value: "none" }]), s(".class, .object, .disjoint, .objectproperty, .disjointwith, .equivalentproperty, .transitiveproperty, .functionalproperty, .inversefunctionalproperty, .symmetricproperty, .allvaluesfromproperty, .somevaluesfromproperty", [{ name: "fill", value: "#acf" }]), s(".label .datatype, .datatypeproperty", [{ name: "fill", value: "#9c6" }]), s(".rdf, .rdfproperty", [{ name: "fill", value: "#c9c" }]), s(".literal, .node .datatype", [{ name: "fill", value: "#fc3" }]), s(".deprecated, .deprecatedproperty", [{ name: "fill", value: "#ccc" }]), s(".external, .externalproperty", [{ name: "fill", value: "#36c" }]), s("path, .nofill", [{ name: "fill", value: "none" }]), s("marker path", [{ name: "fill", value: "#000" }]), s(".class, path, line, .fineline", [{ name: "stroke", value: "#000" }]), s(".white, .subclass, .subclassproperty, .external + text", [{ name: "fill", value: "#fff" }]), s(".class.hovered, .property.hovered, .cardinality.hovered, .cardinality.focused, circle.pin, .filled.hovered, .filled.focused", [{ name: "fill", value: "#f00" }, { name: "cursor", value: "pointer" }]), s(".focused, path.hovered", [{ name: "stroke", value: "#f00" }]), s(".indirect-highlighting, .feature:hover", [{ name: "fill", value: "#f90" }]), s(".values-from", [{ name: "stroke", value: "#69c" }]), s(".symbol, .values-from.filled", [{ name: "fill", value: "#69c" }]), s(".class, path, line", [{ name: "stroke-width", value: "2" }]), s(".fineline", [{ name: "stroke-width", value: "1" }]), s(".dashed, .anonymous", [{ name: "stroke-dasharray", value: "8" }]), s(".dotted", [{ name: "stroke-dasharray", value: "3" }]), s("rect.focused, circle.focused", [{ name: "stroke-width", value: "4px" }]), s(".nostroke", [{ name: "stroke", value: "none" }]), s("marker path", [{ name: "stroke-dasharray", value: "100" }]) }
                ...
                function c(e, t) { return "fill" === t && d(e) }

                function d(e) { var t = e.datum(); return t.backgroundColor && !!t.backgroundColor() }

                function u() { t.selectAll(".hidden-in-export").style("display", "none") }
                ...
                function f() { t.selectAll(".hidden-in-export").style("display", null) }
                ...
                function h() {
                    ...
                    for (var p = 0; p < r.length; p++) {
                        ...
                        for (n = 0; n < c.length; n++)
                            if (u = c[n], u.id === f.id()) { u.pos = [r[p].x, r[p].y], r[p].pinned() && (u.pinned = !0); break }
                    }
                    i.settings = {};
                    var h = e.scaleFactor(),
                        v = e.paused(),
                ...
                }, x.setFilename = function (e) { g = e || "export" }, x.setJsonText = function (e) { b = e }, x
            }
        }).call(t, n(6))
    },
    319: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
                function n(n, o, r, i) {
                    var a, l;
                    a = t.select(i).append("div").classed("checkboxContainer", !0), l = a.append("input").classed("filterCheckbox", !0).attr("id", o + "FilterCheckbox").attr("type", "checkbox").property("checked", n.enabled()), d.push({ checkbox: l, defaultState: n.enabled() }), l.on("click", function (t) {
                ...
                function o(t, n) {
                    t.setMaxDegreeSetter(function (e) { s.attr("max", e), i(s, Math.min(e, s.property("value"))) }), t.setDegreeGetter(function () { return +s.property("value") }), t.setDegreeSetter(function (e) { i(s, e) });
                    var o, a;
                    o = n.append("div").classed("distanceSliderContainer", !0), s = o.append("input").attr("id", "nodeDegreeDistanceSlider").attr("type", "range").attr("min", 0).attr("step", 1), o.append("label").classed("description", !0).attr("for", "nodeDegreeDistanceSlider").text("Degree of collapsing"), a = o.append("label").classed("value", !0).attr("for", "nodeDegreeDistanceSlider").text(0), s.on("change", function (t) { t !== !0 && (e.update(), l = s.property("value")) }), s.on("input", function () {
                        var e = s.property("value");
                        a.text(e)
                    }), s.on("wheel", r), s.on("focusout", function () { s.property("value") !== l && e.update() })
                }
                ...
                function a() { u.node().addEventListener("animationend", function () { console.log("filter button animation ended"), u.classed("buttonPulse", !1), u.classed("filterMenuButtonHighlight", !0) }) }
                var l, s, c = {},
                    d = [],
                    u = t.select("#filterOption a"),
                    p = t.select("#nodeDegreeFilteringOption"),
                    f = 0;
                return c.setDefaultDegreeValue = function (e) { f = e }, c.getDefaultDegreeValue = function () { return f }, c.getGraphObject = function () { return e }, c.getCheckBoxContainer = function () { return d }, c.getDegreeSliderValue = function () { return s.property("value") }, c.setup = function (r, i, l, s, d, f) {
                    var h = t.select("#filterOption");
                    h.on("mouseover", function () {
                        var t = e.options().searchMenu();
                        t.hideSearchEntries()
                    }), u.on("mouseleave", function () { c.highlightForDegreeSlider(!1) }), n(r, "datatype", "Datatype properties", "#datatypeFilteringOption"), n(i, "objectProperty", "Object properties", "#objectPropertyFilteringOption"), n(l, "subclass", "Solitary subclasses", "#subclassFilteringOption"), n(s, "disjoint", "Class disjointness", "#disjointFilteringOption"), n(d, "setoperator", "Set operators", "#setOperatorFilteringOption"), o(f, p), a()
                }, c.reset = function () {
                ...
                }, c.killButtonAnimation = function () { u.classed("buttonPulse", !1), u.classed("filterMenuButtonHighlight", !1) }, c.highlightForDegreeSlider = function (e) { if (arguments.length || (e = !0), u.classed("highlighted", e), p.classed("highlighted", e), u.classed("buttonPulse") === !0 && e === !0) { u.classed("buttonPulse", !1); var t = setTimeout(function () { u.classed("buttonPulse", e), clearTimeout(t) }, 100) } else u.classed("buttonPulse", e), u.classed("filterMenuButtonHighlight", e) }, c.setCheckBoxValue = function (e, t) { for (var n = 0; n < d.length; n++) { var o = d[n].checkbox.attr("id"); if (o === e) { d[n].checkbox.property("checked", t); break } } }, c.getCheckBoxValue = function (e) { for (var t = 0; t < d.length; t++) { var n = d[t].checkbox.attr("id"); if (n === e) return d[t].checkbox.property("checked") } }, c.setDegreeSliderValue = function (e) { s.property("value", e) }, c.getDegreeSliderValue = function () { return s.property("value") }, c.updateSettings = function () {
                    var e = !0,
                        t = s.property("value");
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                function o(n, o, r, i, a) {
                    var l, s;
                    return l = t.select(i).append("div").classed("checkboxContainer", !0).datum({ module: n, defaultState: n.enabled() }), s = l.append("input").classed("moduleCheckbox", !0).attr("id", o + "ModuleCheckbox").attr("type", "checkbox").property("checked", n.enabled()), p.push(s), s.on("click", function (t, n) {
                ...
                function a(e) { return e ? d : c }
                var l, s, c = { text: "Multicolor", type: "same" },
                    d = { text: "Multicolor", type: "gradient" },
                    u = {},
                    p = [];
                return u.colorModeState = function (e) { return arguments.length ? (l.datum().active = e, u) : l.datum().active }, u.setDynamicLabelWidth = function (e) { s.property("checked", e) }, u.getCheckBoxContainer = function () { return p }, u.colorModeSwitch = function () { return l }, u.setup = function (i, a, s, c) {
                ...
                }, u.setCheckBoxValue = function (e, t) { for (var n = 0; n < p.length; n++) { var o = p[n].attr("id"); if (o === e) { p[n].property("checked", t); break } } }, u.getCheckBoxValue = function (e) { for (var t = 0; t < p.length; t++) { var n = p[t].attr("id"); if (n === e) return p[t].property("checked") } }, u.setColorSwitchState = function (e) { u.colorModeState(!e) }, u.setColorSwitchStateUsingURL = function (e) { u.colorModeState(!e), l.on("click")(!0) }, u.updateSettingsUsingURL = function () {
                    var e = !0;
                    p.forEach(function (t) { t.on("click")(t.datum(), e) })
                }, u.updateSettings = function () {
                    var e = !0;
                    p.forEach(function (t) { t.on("click")(t.datum(), e) }), l.on("click")(e)
                }, u
            }
        }).call(t, n(6))
    },
    322: function (e, t, n) {
        (function (t) {
            ...
            e.exports = function (e) {
                ...
                function u(n) { var o = A[n]; if (o) return g(), k(o, n), y(!0), E === !0 && C.emptyGraphError(), void m(); var r = t.select("#file-converter-input").property("files")[0]; return !r || n && n !== r.name ? (k(void 0, void 0), y(!1, void 0, 'No cached version of "' + n + '" was found. Please reupload the file.'), void e.clearGraphData()) : (n = r.name, void(n.match(/\.json$/) ? (g(), p(r, n)) : f(r, n, !0))) }

                function p(e, t) {
                    var n = new FileReader;
                    n.readAsText(e), n.onload = function () { g(), h(n.result, t), y(!0), E === !0 && C.emptyGraphError(), m() }
                }
                ...
                function f(n, o, r) {
                    ...
                    l.open("POST", "convert", !0), l.onload = function () { i.property("disabled", !1), 200 === l.status ? (h(l.responseText, o), A[o] = l.responseText) : (k(void 0, void 0), y(!1, l.responseText), m(), e.clearGraphData()), m(), E === !0 && r === !0 && (console.log("Failed to convert the file"), A[o] = void 0, C.notValidJsonFile()) }, l.send(a)
                }
                ...
                function v() {
                    function e() { n.style("display", void 0), clearTimeout(b), t.select(window).on("click", void 0).on("keydown", void 0), n.on("mouseover", void 0) }
                    var n = t.select("#select .toolTipMenu");
                    n.on("click", function () { t.event.stopPropagation() }).on("keydown", function () { t.event.stopPropagation() }), n.style("display", "block"), clearTimeout(b), b = setTimeout(function () { e() }, 3e3), t.select(window).on("click", function () { e() }).on("keydown", function () { e() }), n.on("mouseover", function () { e() })
                }

                function g() { w.classed("hidden", !0), O.classed("hidden", !1) }
                ...
                function m() { O.classed("hidden", !0) }
                var b, x, k, C = {},
                    // S = "foaf",
                    S = "dpmm", //// changed default ontology on load
                    w = t.select("#loading-error"),
                    O = t.select("#loading-progress"),
                    E = !1,
                    A = {};
                return String.prototype.beginsWith = function (e) { return 0 === this.indexOf(e) }, C.setup = function (o) {
                    k = o;
    ...
    325: function (e, t) {
        function n(e) { return function (t) { return null == e ? void 0 : e[t] } } e.exports = n
    },
    326: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
    ...
    327: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
                function n() { e.resetSearchHighlight(), e.options().searchMenu().clearText(), i.classDistance(a.classDistance()), i.datatypeDistance(a.datatypeDistance()), i.charge(a.charge()), i.gravity(a.gravity()), i.linkStrength(a.linkStrength()), e.reset(), o.forEach(function (e) { e.reset() }), e.updateStyle() }
                var o, r = {},
                    i = e.graphOptions(),
                    a = webvowl.options();
    ...
    328: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
                ...
                function r() { k ? g.hideSearchEntries() : g.showSearchEntries() }
                ...
                return String.prototype.beginsWith = function (e) { return 0 === this.indexOf(e) }, g.requestDictionaryUpdate = function () {
                    ...
                    n.on("click", function () { e.locateSearchResult() }), n.on("mouseover", function () { g.hideSearchEntries() })
                }, g.hideSearchEntries = function () { u.style("display", "none"), k = !1 }, g.showSearchEntries = function () { u.style("display", "block"), k = !0 }, g.getSearchString = function () { return d.node().value }, g.clearText = function () { d.node().value = "", t.select("#locateSearchResult").classed("highlighted", !1), t.select("#locateSearchResult").node().title = "Nothing to locate, enter search term."; for (var e = u.node().children, n = e.length, o = 0; o < n; o++) e[0].remove() }, g
            }
        }).call(t, n(6))
    },
    329: function (e, t, n) {
        (function (t) {
            e.exports = function (e) {
                function n() {
                    u.on("mouseover", function () {
                        ...
                        if (1 !== c[0]) {
                            ...
                            for (c[o] = 1, s[o].style.display = "block", e = l + 1; e < c.length; e++) { if (c[e] = 0, s[e].style.display = "block", t = s[o].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, t !== n) { s[e].style.display = "none", c[e] = 0; break } c[e] = 1 } r();
                            var d = i(),
                                u = c.lastIndexOf(1);
                            d || (c[u] = 0, s[u].style.display = "none");
                            var p = c.lastIndexOf(1);
                            for (e = p - 1; e >= 0; e--) { if (c[e] = 0, s[e].style.display = "block", t = s[o].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, t !== n) { s[e].style.display = "none", c[e] = 0; break } c[e] = 1 } r(), d = i(), d || (u = c.indexOf(1), u !== -1 && (c[u] = 0, s[u].style.display = "none")), r(), d = i(), d || (u = c.indexOf(1), u !== -1 && (c[u] = 0, s[u].style.display = "none")), r(), d = i(), d || (u = c.indexOf(1), u !== -1 && (c[u] = 0, s[u].style.display = "none")), r(), a()
                        }
                    }), p.on("click", function () {
                        if (1 !== c[c.length - 1]) {
                            ...
                            for (c[t] = 1, s[t].style.display = "block", e = n - 1; e >= 0; e--) {
                                ...
                                if (o !== l) { s[e].style.display = "none", c[e] = 0; break } c[e] = 1
                            }
                            r();
                            var d = i();
                            if (!d) {
                ...
                return l.setup = function () { var e, t = d.node().children; for (e = 0; e < t.length; e++) s.push(t[e]); for (n(), e = 0; e < s.length - 2; e++) s[e].style.display = "block", c[e] = 1 }, l.updateVisibilityStatus = function () {
                    ...
                    var d = c.indexOf(1),
                        u = c.lastIndexOf(1);
                    for (d === -1 && u === -1 && (o(), d = c.indexOf(1), u = c.lastIndexOf(1)), e = d + 1; e < s.length - 2; e++) { if (s[e].style.display = "block", l = s[d].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, l !== n) { s[e].style.display = "none", c[e] = 0; break } c[e] = 1 } r();
                    var p, f = i();
                    if (f || 0 !== d || (p = c.lastIndexOf(1), p !== -1 && (c[p] = 0, s[p].style.display = "none")), 0 !== d || u !== c.length) { if (u = c.lastIndexOf(1), u >= 1) { for (e = u - 1; e >= 0; e--) c[e] = 0, s[e].style.display = "none"; for (e = u - 1; e >= 0; e--) { if (c[e] = 0, s[e].style.display = "block", l = s[u].getBoundingClientRect().top, n = s[e].getBoundingClientRect().top, l !== n) { s[e].style.display = "none", c[e] = 0; break } c[e] = 1 } } r(), f = i(), f || (p = c.indexOf(1), p !== -1 && (c[p] = 0, s[p].style.display = "none")) } c.indexOf(1) === -1 && o(), a()
                }, l
            }
        }).call(t, n(6))
    },
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                function o(n) {
                    ...
                    var o = t.select("#language").on("change", function () { e.language(t.event.target.value), i(), S.updateSelectionInformation(C) });
                ...
                function s(e, n) {
                    ...
                    e.selectAll(".annotation").remove(), e.selectAll(".annotation").data(o).enter().append("p").classed("annotation", !0).classed("statisticDetails", !0).text(function (e) { return e.identifier + ":" }).append("span").each(function (e) { h(t.select(this), e.value, "iri" === e.type ? e.value : void 0) })
                }
                ...
                function y(e) {
                    ...
                    void 0 !== e.disjointWith() ? (o.selectAll("*").remove(), e.disjointWith().forEach(function (e, t) { t > 0 && o.append("span").text(", "), h(o, e.labelForCurrentLanguage(), e.iri()) }), r.classed("hidden", !1)) : r.classed("hidden", !0), v(e.attributes(), t.select("#classAttributes")), x(t.select("#nodeDescription"), e.descriptionForCurrentLanguage()), x(t.select("#nodeComment"), e.commentForCurrentLanguage()), s(t.select("#classSelectionInformation"), e.annotations())
                }
                ...
                function b(e, n) {
                    ...
                    n && n.length ? (e.selectAll("*").remove(), n.forEach(function (t, n) { n > 0 && e.append("span").text(", "), h(e, t.labelForCurrentLanguage(), t.iri()) }), o.classed("hidden", !1)) : o.classed("hidden", !0)
                }
                ...
                return S.setup = function () { n() }, S.clearOntologyInformation = function () {
                ...
                }, S.updateOntologyInformation = function (e, t) { e = e || {}, k = e.header || {}, i(), a(e.metrics, t), l(k.other), S.updateSelectionInformation(void 0), o(k.languages) }, S.updateSelectionInformation = function (e) {
